...
# Generated opcode tables (gen_opc, opc) — the loader's instruction
# dispatch lives here. Generated by beam_makeops; just use the
# already-generated copy from the JIT build dir.
EXTRA_C_SRCS=(
    "$ROOT/erts/emulator/$ARCH/opt/jit/beam_opcodes.c"
)
C_SRCS+=("${EXTRA_C_SRCS[@]}")
