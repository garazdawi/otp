...
boot_module_load(Config) ->
    ...
    [BeforeKernelStart, MinimalModules, DefaultModules] =
    ...
    MinimalModulesSet = sets:union(sets:from_list(MinimalModules), PreLoadedMandatory),
    ...
    MinimalAfterKernelStartSet = sets:union(sets:from_list(MinimalAfterKernelStart), PreLoaded),
    DefaultAfterKernelStartSet = sets:union(sets:from_list(DefaultAfterKernelStart), PreLoaded),
...
run_modules() ->
    erl_prim_loader:load_modules([code]),
